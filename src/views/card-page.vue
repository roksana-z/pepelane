  ...
  <div class="card-page container max-width">
    ...
    <div class="card-page__content">
        ...
        <ul class="card-page__menu menu">
            <router-link class="menu__link" :to="{ name: 'specification' }"  ><li class="menu__item">Specifications</li></router-link>
            <router-link :to="{ name: 'team' }" class="menu__link" ><li class="menu__item">Team</li></router-link>
            <router-link :to="{ name: 'terms' }" class="menu__link" ><li class="menu__item">Rent terms</li></router-link>
        </ul>
