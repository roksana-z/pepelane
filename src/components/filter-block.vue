<template>
  <div class="filter-block">
        <div class="filter-block__title-wrapper">
            <span class="filter-block__rent">Rent </span><span class="filter-block__whatever">whatever</span>
            <div class='select'>
                <svg display="none">
                ...
                <svg >
                    <use xlink:href="#select_arrow" width="12px" height="8px" class="select__btn"></use>
                </svg>
